...
learning_rate = 0.001
dropout = 0.9
data_dir = 'E:/Programming/python/TF-in-action/3.2'
log_dir = 'E:/Programming/python/TF-in-action/9.1'
...
def variable_summaries(var):
    with tf.name_scope('summaries'):
        ...
        tf.summary.histogram('hirtogram', var)
...
y = nn_layer(dropped, 500, 10, 'layer2', tf.identity)
